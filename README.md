...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/validate_imei \
  -H 'Content-Type: application/json' \
  -d '{"imei":"490154203237518"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/validate_imei`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
